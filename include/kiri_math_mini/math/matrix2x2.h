/*
 * @Author: Doyub Kim 
 * @Date: 2020-03-17 16:10:58 
 * @Last Modified by: Xu.Wang
 * @Last Modified time: 2020-04-05 20:50:56
 */
#ifndef _KIRI_MATH_MATRIX2X2_H_
#define _KIRI_MATH_MATRIX2X2_H_
...
namespace kiri_math_mini
{
    ...
    public:
        ...
        //! Makes scale matrix.
        static Matrix scaleMatrix(T sx, T sy);

        //! Makes scale matrix.
        static Matrix scaleMatrix(const Vector2<T> &s);

        //! Makes rotation matrix.
        //! \warning Input angle should be radian.
        static Matrix rotationMatrix(const T &rad);
...
#include "inl/matrix2x2-inl.h"

#endif // _KIRI_MATH_MATRIX2X2_H_
