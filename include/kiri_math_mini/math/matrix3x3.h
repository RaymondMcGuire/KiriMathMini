/*
 * @Author: Doyub Kim 
 * @Date: 2020-03-17 16:10:53 
 * @Last Modified by: Xu.Wang
 * @Last Modified time: 2020-04-05 20:51:54
 */
#ifndef _KIRI_MATH_MATRIX3X3_H_
#define _KIRI_MATH_MATRIX3X3_H_
...
namespace kiri_math_mini
{
    ...
    public:
        ...
        //! Makes scale matrix.
        static Matrix scaleMatrix(const Vector3<T> &s);

        //! Makes rotation matrix.
        //! \warning Input angle should be radian.
        static Matrix rotationMatrix(const Vector3<T> &axis, T rad);
...
#include "inl/matrix3x3-inl.h"

#endif // _KIRI_MATH_MATRIX3X3_H_
