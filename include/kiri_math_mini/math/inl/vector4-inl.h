...
#ifndef _KIRI_MATH_DETAIL_VECTOR4_INL_H_
#define _KIRI_MATH_DETAIL_VECTOR4_INL_H_
...
namespace kiri_math_mini
{
    ...
    template <typename T>
    constexpr size_t Vector<T, 4>::size() const
    {
        return 4;
    }
    ...
    {
        return kiri_math_mini::absmin(kiri_math_mini::absmin(x, y), kiri_math_mini::absmin(z, w));
    }

    template <typename T>
    T Vector<T, 4>::absmax() const
    {
        return kiri_math_mini::absmax(kiri_math_mini::absmax(x, y), kiri_math_mini::absmax(z, w));
    }
...
#endif // _KIRI_MATH_DETAIL_VECTOR4_INL_H_
