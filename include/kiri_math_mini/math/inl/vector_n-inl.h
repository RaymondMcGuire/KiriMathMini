...
#ifndef _KIRI_MATH_DETAIL_VECTOR_N_INL_H_
#define _KIRI_MATH_DETAIL_VECTOR_N_INL_H_

#include <kiri_math_mini/platform.h>
#include <kiri_math_mini/math/math_utils.h>
#include <kiri_math_mini/parallel.h>
#include <kiri_math_mini/math/vector_n.h>
...
namespace kiri_math_mini
{
    ...
    T VectorN<T>::min() const
    {
        ...
        return parallelReduce(
            kZeroSize, size(), std::numeric_limits<T>::max(),
            [&](size_t start, size_t end, T init)
            {
                T result = init;
                for (size_t i = start; i < end; ++i)
    ...
    T VectorN<T>::max() const
    {
        ...
        return parallelReduce(
            kZeroSize, size(), std::numeric_limits<T>::min(),
            [&](size_t start, size_t end, T init)
            {
                T result = init;
                for (size_t i = start; i < end; ++i)
    ...
    T VectorN<T>::absmin() const
    {
        return parallelReduce(
            ...
            [&](size_t start, size_t end, T init)
            {
                ...
                for (size_t i = start; i < end; ++i)
                {
                    result = kiri_math_mini::absmin(result, _elements[i]);
                }
                return result;
            },
            kiri_math_mini::absmin<T>);
    }
    ...
    T VectorN<T>::absmax() const
    {
        return parallelReduce(
            ...
            [&](size_t start, size_t end, T init)
            {
                ...
                for (size_t i = start; i < end; ++i)
                {
                    result = kiri_math_mini::absmax(result, _elements[i]);
                }
                return result;
            },
            kiri_math_mini::absmax<T>);
    }
...
#endif // _KIRI_MATH_DETAIL_VECTOR_N_INL_H_
