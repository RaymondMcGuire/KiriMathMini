...
#ifndef _KIRI_MATH_DETAIL_MATRIX_CSR_INL_H_
#define _KIRI_MATH_DETAIL_MATRIX_CSR_INL_H_
...
namespace kiri_math_mini
{
    ...
    T MatrixCsr<T>::sum() const
    {
        return parallelReduce(
            kZeroSize, numberOfNonZeros(), T(0),
    ...
    T MatrixCsr<T>::absmin() const
    {
        return parallelReduce(
            ...
            [&](size_t start, size_t end, T init)
            {
                ...
                for (size_t i = start; i < end; ++i)
                {
                    result = kiri_math_mini::absmin(result, _nonZeros[i]);
                }
                return result;
            },
    ...
    T MatrixCsr<T>::absmax() const
    {
        return parallelReduce(
            ...
            [&](size_t start, size_t end, T init)
            {
                ...
                for (size_t i = start; i < end; ++i)
                {
                    result = kiri_math_mini::absmax(result, _nonZeros[i]);
                }
                return result;
            },
...
#endif // _KIRI_MATH_DETAIL_MATRIX_CSR_INL_H_
