/*
 * @Author: Doyub Kim  
 * @Date: 2020-03-20 14:08:31 
 * @Last Modified by: Xu.Wang
 * @Last Modified time: 2020-03-20 14:11:42
 */
#ifndef _KIRI_MATH_DETAIL_MATRIX_INL_H_
#define _KIRI_MATH_DETAIL_MATRIX_INL_H_
...
namespace kiri_math_mini
{
    ...
    T Matrix<T, M, N>::absmin() const
    {
        ...
        for (auto v : _elements)
        {
            ret = kiri_math_mini::absmin(ret, v);
        }
        return ret;
    }
    ...
    T Matrix<T, M, N>::absmax() const
    {
        ...
        for (auto v : _elements)
        {
            ret = kiri_math_mini::absmax(ret, v);
        }
        return ret;
    }
...
#endif // _KIRI_MATH_DETAIL_MATRIX_INL_H_
