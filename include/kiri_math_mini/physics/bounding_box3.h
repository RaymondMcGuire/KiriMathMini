/*
 * @Author: Doyub Kim 
 * @Date: 2020-04-01 16:51:44 
 * @Last Modified by:   Xu.Wang 
 * @Last Modified time: 2020-04-01 16:51:44 
 */
#ifndef _KIRI_MATH_BOUNDING_BOX3_H_
#define _KIRI_MATH_BOUNDING_BOX3_H_
...
namespace kiri_math_mini
{
    ...
    public:
        ...
        //! Init Bbox with center & radius
        void setBboxWithCenter(Vector3<T> center, T radius);

        //! Init Bbox with center & long side & short side
        void setBboxWithCenter(Vector3<T> center, T longSide, T shortSide);

        //! Init Bbox with center & xSide & ySide & zSide
        void setBboxWithCenter(Vector3<T> center, T xSide, T ySide, T zSide);
...
#include "inl/bounding_box3-inl.h"

#endif // _KIRI_MATH_BOUNDING_BOX3_H_
