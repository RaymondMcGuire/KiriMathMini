...
#ifndef _KIRI_MATH_DETAIL_ARRAY3_INL_H_
#define _KIRI_MATH_DETAIL_ARRAY3_INL_H_
...
namespace kiri_math_mini
{
                          ...
                          std::initializer_list<std::initializer_list<T>>> &lst)
    {
        ...
        for (size_t k = 0; k < depth; ++k)
        {
            ...
            KIRI_MATH_ASSERT(height == pageIter->size());
    ...
    {
        KIRI_MATH_ASSERT(i < _size.x * _size.y * _size.z);
        return _data[i];
    }
    ...
    {
        KIRI_MATH_ASSERT(i < _size.x && j < _size.y && k < _size.z);
    ...
    {
        KIRI_MATH_ASSERT(pt.x < _size.x && pt.y < _size.y && pt.z < _size.z);
...
#endif // _KIRI_MATH_DETAIL_ARRAY3_INL_H_
