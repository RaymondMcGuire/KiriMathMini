#ifndef _KIRI_MATH_DETAIL_ARRAY_SAMPLERS2_INL_H_
#define _KIRI_MATH_DETAIL_ARRAY_SAMPLERS2_INL_H_
...
namespace kiri_math_mini
{
        ...
        std::array<R, 4> *weights) const
    {
        ...
        KIRI_MATH_ASSERT(_gridSpacing.x > 0.0 && _gridSpacing.y > 0.0);
...
#endif // _KIRI_MATH_DETAIL_ARRAY_SAMPLERS2_INL_H_
