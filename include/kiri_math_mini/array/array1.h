 ...
 * @Last Modified time: 2019-12-13 22:39:18
 */
#ifndef _KIRI_MATH_ARRAY1_H_
#define _KIRI_MATH_ARRAY1_H_
...
namespace kiri_math_mini
{
    ...
    public:
        ...
        //! Remove the i-th element， need recompute the index
        void remove(size_t i);

        //! Remove the elements from start to end
        void remove(size_t start, size_t end);

        //! Remove the i-th element， dont need recompute the index but not retain the original order
        //! note: need delete from the back to front
        void removeq(size_t i);
...
#include "inl/array1-inl.h"

#endif // _KIRI_MATH_ARRAY1_H_
